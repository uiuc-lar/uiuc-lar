...
SequenceLearnerDisc::SequenceLearnerDisc(int r_, int * d_, int n_, int b_, int epochs_, double thresh_, bool makeLR_)
	: r(r_), d(d_), nOuts(n_), b(b_), epochs(epochs_), lThresh(thresh_), makeLR(makeLR_) {
